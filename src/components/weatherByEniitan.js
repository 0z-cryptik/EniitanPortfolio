    ...
    <figure className="lg:w-[80%] w-fit lg:border lg:p-5 lg:rounded-xl mx-auto lg:mt-7 mt-[5rem]">
      ...
      <figcaption>
        ...
        <p>
          ...
          that provides current weather information and weather forecasts
          for your location or any city in the world. It also allows you to
        ...
        <ul className="list-disc ml-5">
          ...
          <li className="mb-3">
            ...
            access, or you have a setting that prevents location access,
            the app will display the current weather and forecasts for the
            default location (Accra, Ghana).
          </li>
          <li className="mb-3">
            <b>Search for Any City:</b> You can search for any city in the
            world using the search bar and you will be provided with
            accurate weather information for that city. You can also search
            for certain specific popular places.
          </li>
          <li className="mb-3">
          ...
          <li>
            <b>Remembers Your Preference:</b> Your selected temperature
            unit (Celsius or Fahrenheit) will be remembered and applied
            every time you revisit the site, providing a personalized
            experience.
          </li>
        </ul>
