...
export const NewsByEniitan = () => {
    ...
    return <figure className="w-[80%] border p-5 rounded-xl mx-auto mt-7">
        ...
        <div className="relative" onMouseOver={() => setHover(true)} onMouseLeave={() => setHover(false)}>
            ...
            <img  className={`mb-5 border ${hover ? 'opacity-70' : ''} transition-opacity ease-linear`} src="https://res.cloudinary.com/ds7xwxu4j/image/upload/v1696658942/Screenshot_93_3_ibfpdo.png" />

            <div className={`${hover ? '' : 'hidden'} absolute top-[33%] left-[33.5%] flex flex-row w-fit`}>
