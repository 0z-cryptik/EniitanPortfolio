...
export const NewsByEniitan = () => {
    ...
    return (
        <figure className="w-[80%] border p-5 rounded-xl mx-auto mt-7">
            ...
            <figcaption>
                ...
                <p>
                    This News Web App is a user-friendly web application that
                    allows users to enjoy news summaries from around the world
                    across various categories in their feed, users can get a
                    general grasp of happenings around the world without having
                    to read much, and should they come across an headline that
                    interests them, they can click on the headline to read the
                    full article.
                </p>
                ...
                <ul className="list-disc ml-5">
                    <li className="mb-3">
                        <b>News Feed:</b> Users can stay up-to-date with news
                        summaries from various sources and categories in one
                        convenient feed.
                    </li>
                    <li className="mb-3">
                        <b>Dark Mode and Light Mode:</b> The app offers both
                        Dark Mode and Light Mode options for comfortable reading
                        in different lighting conditions.
                    </li>
                    <li className="mb-3">
                        <b>User Preference Memory:</b> The web app remembers the
                        user's selected mode and automatically applies it upon
                        their return.
                    </li>
                    <li>
                        <b>Responsive Design:</b> The application is designed to
                        provide an optimal experience on phones, PCs and
                        tablets, with a user-friendly menu for easy navigation
                        between different news categories (on phones & tablets).
                    </li>
                </ul>
